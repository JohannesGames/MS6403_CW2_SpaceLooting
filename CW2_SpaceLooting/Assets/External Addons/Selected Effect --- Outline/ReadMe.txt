...
=> "Demo3D" demonstrates all outline features with perspective camera.
=> "Demo2D" demonstrates all outline features with orthographic camera.
...
What is in "Demo2D" ?
=> The outline effect also works fine with sprite renderer.
=> Just move the cursor to the girl sprite, you will see the outline result.
=> There are 2 type of sprite outline, outline with sprite and outline only.
